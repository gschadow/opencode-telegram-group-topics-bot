...
export const de: I18nDictionary = {
  ...
  "cmd.description.cancel": "Menü oder Frage schließen ohne Abbruch",
  ...
  "projects.enter_path_button": "📁 Enter path...",
  "projects.enter_path_prompt": "Enter the full directory path:",
  "projects.enter_path_invalid": "⚠️ Directory not found: {path}",
  "projects.enter_path_success": "✅ Project set to: {path}",
  "mcps.header": "🔌 MCP Servers:",
  "mcps.empty": "No MCP servers configured.",
  "mcps.fetch_error": "🔴 Failed to fetch MCP server status.",
  "mcps.error": "🔴 An error occurred while loading MCP servers.",
  "mcps.button.connect": "▶ Connect {name}",
  "mcps.button.disconnect": "⏹ Disconnect {name}",
  "mcps.connected": "✅ {name} connected",
  "mcps.disconnected": "⏹ {name} disconnected",
  "mcps.connect_error": "🔴 Failed to connect {name}",
  "mcps.disconnect_error": "🔴 Failed to disconnect {name}",
  "cmd.description.mcps": "List MCP server statuses",
  "cmd.description.models": "Select model",
